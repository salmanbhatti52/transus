...
let PaymentDetailPage = class PaymentDetailPage {
    constructor(toastController, loadingController, storage, restService, activatedRoute, router, menuCtrl) {
...
//# sourceMappingURL=payment-detail-payment-detail-module-es2015.js.map