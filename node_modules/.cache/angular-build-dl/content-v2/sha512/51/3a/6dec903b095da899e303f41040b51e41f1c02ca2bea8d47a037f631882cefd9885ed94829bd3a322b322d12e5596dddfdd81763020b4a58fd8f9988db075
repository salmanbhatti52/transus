(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["filters-filters-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppFiltersFiltersPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppFiltersFiltersRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var FiltersPageRoutingModule = /*#__PURE__*/_createClass(function FiltersPageRoutingModule() {
    ...
    /***/
    function srcAppFiltersFiltersModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var FiltersPageModule = /*#__PURE__*/_createClass(function FiltersPageModule() {
    ...
    /***/
    function srcAppFiltersFiltersPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppFiltersFiltersPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var FiltersPage = /*#__PURE__*/function () {
        function FiltersPage(storage, zone, router, toastController, restService, menuCtrl, plateform, loadingController) {
        ...
        _createClass(FiltersPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.storage.get('user_details').then(function (user_details) {
              _this.storage.get('currency_symbol').then(function (currency_symbol) {
                ...
                console.log('currency', _this.currencyID); // this.getDropDownData();
          ...
          value: function getDropDownData() {
            ...
            this.restService.filters(stringy).subscribe(function (response) {
              ...
              console.log('resssspppppp---------', _this3.response);

              _this3.dismiss();

              _this3.makes = _this3.response.makes;
              _this3.models = _this3.response.models;
              _this3.transmissions = _this3.response.transmission;
              _this3.vehSeats = _this3.response.veh_seats;
              _this3.vehicle_types = _this3.response.vehicle_types;
              _this3.max_price = parseInt(_this3.response.max_price);
              _this3.min_price = parseInt(_this3.response.min_price);
              _this3.upperPrice = _this3.max_price;
              _this3.lowerPrice = _this3.min_price;
              console.log(_this3.max_price, _this3.min_price);
              _this3.price = {
                upper: _this3.max_price,
                lower: _this3.min_price
              };
          ...
          key: "getYearsVal",
          value: function getYearsVal() {
            this.yearsText = this.years.split(',')[1];
            this.yearsShowList = true;
          }
        }, {
          key: "openYears",
          value: function openYears() {
            this.yearsShowList = false;
            this.yearsSelect.open();
          }
        }, {
          key: "getnosVal",
          value: function getnosVal() {
            this.nosText = this.nos.split(',')[1];
            this.nosShowList = true;
          }
        }, {
          key: "openNos",
          value: function openNos() {
            this.nosShowList = false;
            this.nosSelect.open();
          }
        }, {
          key: "getTransmissionVal",
          value: function getTransmissionVal() {
            this.transmissionText = this.transmission.split(',')[1];
            this.transmissionShowList = true;
          }
        }, {
          key: "openTransmission",
          value: function openTransmission() {
          ...
          value: function submitForm() {
            ...
            if (this.price == undefined) {
              ...
              this.lowerPrice = 0;
              this.upperPrice = 0; //alert('2'+this.lowerPrice);
            }
            ...
            this.restService.filters(stringy).subscribe(function (response) {
              ...
              if (_this4.response.status == 'NotFound') {
                var myData = JSON.stringify({
                  cars_list_result: _this4.NoDataFount
                });
                _this4.restService.fromHomeToSearch = myData;

                _this4.router.navigate(['/car-list']); // this.presentToast('Data Not Found!');
                ...
                _this4.restService.fromHomeToSearch = myData;
                _this4.restService.scroolFlag = false;
                _this4.restService.sourceToSearch = null;
                console.log(_this4.restService.fromHomeToSearch, "fromHomeToSearch");
      ...
      FiltersPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        "./node_modules/raw-loader/dist/cjs.js!./src/app/filters/filters.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./filters.page.scss */
        "./src/app/filters/filters.page.scss"))["default"]]
      })], FiltersPage);
      /***/
    }
  }]);
