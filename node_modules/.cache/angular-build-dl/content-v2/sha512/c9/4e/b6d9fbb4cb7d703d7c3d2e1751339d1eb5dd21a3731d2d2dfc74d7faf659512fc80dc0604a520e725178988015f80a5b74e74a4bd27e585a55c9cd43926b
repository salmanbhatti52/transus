...
let ContactSupportPage = class ContactSupportPage {
    constructor(loadingController, activatedRoute, storage, toastController, router, restService, alertCtrl, menuCtrl, plateform) {
...
ContactSupportPage.ctorParameters = () => [
...
//# sourceMappingURL=contact-support-contact-support-module-es2015.js.map