(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@google-pay/button-angular', ['@angular/core','exports', '@angular/core'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,(global['google-pay'] = global['google-pay'] || {}, global['google-pay']['button-angular'] = {}), global.ng.core));
    ...
    ***************************************************************************** */
    ...
    var ButtonManager = /** @class */ (function () {
        function ButtonManager(options) {
             ...
             * @private
             */
            this.handleClick = function (event) { return __awaiter(_this, void 0, void 0, function () {
        ...
        ButtonManager.prototype.removeButton = function () {
            ...
            if (this.element instanceof ShadowRoot || this.element instanceof Element) {
                try {
                    for (var _e = __values(Array.from(this.element.children)), _f = _e.next(); !_f.done; _f = _e.next()) {
                        var child = _f.value;
        ...
        ButtonManager.prototype.appendStyles = function () {
            ...
            var styleId = "default-google-style-" + this.options.cssSelector.replace(/[^\w-]+/g, '') + "-" + ((_b = this.config) === null || _b === void 0 ? void 0 : _b.buttonLocale);
        ...
        function GooglePayButtonComponent(elementRef) {
            ...
            this.initializeButton = debounce(function () {
                ...
                var config = {
                    ...
                    buttonLocale: _this.buttonLocale,
                    ...
                    onClick: function (event) {
                        ...
                        if (_this.clickCallback) {
                            (_a = _this.clickCallback) === null || _a === void 0 ? void 0 : _a.call(_this, event);
                        }
                    },
                };
