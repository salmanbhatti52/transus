(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ngx-image-compress', ['@angular/core','exports', '@angular/core'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global['ngx-image-compress'] = {}, global.ng.core));
    ...
    var ImageCompress = /** @class */ (function () {
         ...
         * @return {?}
         */
        ImageCompress.uploadFile = function (render) {
            /** @type {?} */
         ...
         * @return {?}
         */
        ImageCompress.byteCount = function (s) {
    ...
    var NgxImageCompressService = /** @class */ (function () {
         ...
         * @return {?}
         */
        NgxImageCompressService.prototype.byteCount = function (image) {
         ...
         * @return {?}
         */
        NgxImageCompressService.prototype.getOrientation = function (file) {
            return new Promise(( /**
             * @param {?} resolve
             * @return {?}
             */function (resolve) {
         ...
         * @return {?}
         */
        NgxImageCompressService.prototype.uploadFile = function () {
         ...
         * @return {?}
         */
        NgxImageCompressService.prototype.compressFile = function (image, orientation, ratio, quality) {
            if (ratio === void 0) { ratio = 50; }
            if (quality === void 0) { quality = 50; }
...
NgxImageCompressService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: NgxImageCompressService, factory: function (t) { return NgxImageCompressService.ɵfac(t); } });
