(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["car-booking-car-booking-module"], {
    ...
    function srcAppCarBookingCarBookingPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _imgsr_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! ../imgsr.service */
      "./src/app/imgsr.service.ts");

      var CarBookingPage = /*#__PURE__*/function () {
        function CarBookingPage(activatedRoute, loadingController, storage, toastController, restService, alertCtrl, router, imageService, imagePicker, plateform, location, transfer, imgsr) {
    ...
    /***/
    function srcAppImgsrServiceTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ImgsrService", function () {
        return ImgsrService;
      });
      /* harmony import */
      ...
      var ImgsrService = /*#__PURE__*/_createClass(function ImgsrService() {
        _classCallCheck(this, ImgsrService);
      ...
      ImgsrService.ctorParameters = function () {
        return [];
      };

      ImgsrService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], ImgsrService);
      /***/
    }
