(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["location-location-module"], {
    ...
    function srcAppLocationLocationRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var LocationPageRoutingModule = /*#__PURE__*/_createClass(function LocationPageRoutingModule() {
    ...
    function srcAppLocationLocationModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var LocationPageModule = /*#__PURE__*/_createClass(function LocationPageModule() {
    ...
    function srcAppLocationLocationPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var LocationPage = /*#__PURE__*/function () {
        function LocationPage(storage, fb, activatedRoute, toastController, geolocation, nativeGeocoder, zone, router, plateform, navController, loadingController, locationPlugin) {
          var _this = this;
          ...
          this.activatedRoute.queryParams.subscribe(function (res) {
            ...
            _this.lastVeh = _this.response.vehId;
          });
        ...
        _createClass(LocationPage, [{
          ...
          value: function backToList() {
            ...
            this.storage.set('dropoff', this.destination); //this.navController.navigateBack(this.back);
          ...
          key: "UpdateDestinationResults",
          value: function UpdateDestinationResults() {
            var _this3 = this;
            ...
            this.GoogleAutocomplete.getPlacePredictions({
              ...
              _this3.detinationCompleteItems = [];

              _this3.zone.run(function () {
                predictions.forEach(function (prediction) {
                  console.log(prediction);

                  _this3.detinationCompleteItems.push(prediction);
                });
              });
            });
          }
        }, {
          key: "SelectDestinationResult",
          value: function SelectDestinationResult(address) {
          ...
          key: "getpickuplatlog",
          value: function getpickuplatlog(address) {
            var _this4 = this;
            ...
            this.nativeGeocoder.forwardGeocode(address, options).then(function (result) {
              ...
              _this4.storage.set('pickuplong', result[0].longitude);

              _this4.storage.set('pickuplat', result[0].latitude);

              _this4.getdropofflatlog(_this4.destination);

              _this4.dismiss();
            })["catch"](function (error) {
              _this4.errorMsg = JSON.stringify(error);
              console.log(_this4.errorMsg);

              _this4.dismiss();

              _this4.presentToast(_this4.errorMsg);
            });
          }
        }, {
          key: "getdropofflatlog",
          value: function getdropofflatlog(address) {
            var _this5 = this;
            ...
            this.nativeGeocoder.forwardGeocode(address, options).then(function (result) {
              ...
              _this5.storage.set('dropofflong', result[0].longitude);

              _this5.storage.set('dropofflat', result[0].latitude);

              _this5.locationPlugin.back();
            })["catch"](function (error) {
              _this5.errorMsg = JSON.stringify(error);
              console.log(_this5.errorMsg);

              _this5.presentToast(_this5.errorMsg);
            });
          }
        }, {
          key: "present",
      ...
      LocationPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
