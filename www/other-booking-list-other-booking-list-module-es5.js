    ...
    function srcAppOtherBookingListOtherBookingListPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var OtherBookingListPage = /*#__PURE__*/function () {
        ...
        _createClass(OtherBookingListPage, [{
          ...
          key: "finalAction",
          value: function finalAction(actionType, bookingDetails, type) {
            var _this10 = this;
            ...
            this.restService.booking_action(stringy).subscribe(function (response) {
              ...
              console.log("this.response------ booking action", _this10.response);

              if (_this10.response.status == 'success') {
                if (type == 'Deliver') {
                  bookingDetails.renter_response = 'Delivered';
                  bookingDetails.owner_response = 'notRecevied';

                  _this10.giveRating(bookingDetails.bookings_id);
                }
