(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["listcar7-listcar7-module"], {
    /***/
    "./node_modules/raw-loader/dist/cjs.js!./src/app/listcar7/listcar7.page.html":
    /*!***********************************************************************************!*\
      !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/listcar7/listcar7.page.html ***!
      \***********************************************************************************/
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppListcar7Listcar7PageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    "./src/app/listcar7/listcar7-routing.module.ts":
    /*!*****************************************************!*\
      !*** ./src/app/listcar7/listcar7-routing.module.ts ***!
      \*****************************************************/

    /*! exports provided: Listcar7PageRoutingModule */

    /***/
    function srcAppListcar7Listcar7RoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "Listcar7PageRoutingModule", function () {
        return Listcar7PageRoutingModule;
      });
      /* harmony import */
      ...
      var _listcar7_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./listcar7.page */
      "./src/app/listcar7/listcar7.page.ts");

      var routes = [{
        path: '',
        component: _listcar7_page__WEBPACK_IMPORTED_MODULE_3__["Listcar7Page"]
      }];

      var Listcar7PageRoutingModule = /*#__PURE__*/_createClass(function Listcar7PageRoutingModule() {
        _classCallCheck(this, Listcar7PageRoutingModule);
      });

      Listcar7PageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    "./src/app/listcar7/listcar7.module.ts":
    /*!*********************************************!*\
      !*** ./src/app/listcar7/listcar7.module.ts ***!
      \*********************************************/

    /*! exports provided: Listcar7PageModule */

    /***/
    function srcAppListcar7Listcar7ModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "Listcar7PageModule", function () {
        return Listcar7PageModule;
      });
      /* harmony import */
      ...
      var _listcar7_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./listcar7-routing.module */
      "./src/app/listcar7/listcar7-routing.module.ts");
      /* harmony import */


      var _listcar7_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./listcar7.page */
      "./src/app/listcar7/listcar7.page.ts");

      var Listcar7PageModule = /*#__PURE__*/_createClass(function Listcar7PageModule() {
        _classCallCheck(this, Listcar7PageModule);
      });

      Listcar7PageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _listcar7_routing_module__WEBPACK_IMPORTED_MODULE_5__["Listcar7PageRoutingModule"]],
        declarations: [_listcar7_page__WEBPACK_IMPORTED_MODULE_6__["Listcar7Page"]]
      })], Listcar7PageModule);
      /***/
    },

    /***/
    "./src/app/listcar7/listcar7.page.scss":
    /*!*********************************************!*\
      !*** ./src/app/listcar7/listcar7.page.scss ***!
      \*********************************************/
    ...
    /***/
    function srcAppListcar7Listcar7PageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_exports__["default"] = "ion-toolbar {\n  padding: 0.8em 0.1em 0 0;\n  --background: #c4932f;\n}\n\n@media only screen and (min-height: 800px) {\n  ion-toolbar {\n    padding: 3em 0.1em 8px 0;\n    --background: #c4932f;\n  }\n}\n\nion-title {\n  text-align: center;\n  color: #fff;\n  font-size: 24px;\n}\n\n.error {\n  color: red;\n}\n\n.real_image {\n  padding: 0px;\n}\n\n.real_image img {\n  width: 100%;\n  height: 100px;\n}\n\n.real_image_2 {\n  padding: 0px;\n}\n\n.real_image_2 img {\n  width: 150px;\n  height: 164px;\n}\n\n.list_1 {\n  padding: 0em 1em;\n}\n\n.list_1 h3 {\n  margin: 0px;\n  margin-top: 0.5em;\n}\n\n.left_4 {\n  margin-left: 0.7em !important;\n}\n\n.input_list {\n  border: 1px solid #d4dce1;\n  background: #f7f8fa;\n  border-radius: 28px;\n  font-size: 13px;\n  color: #000;\n  --placeholder-color: #b2b2b4;\n  --padding-bottom: 1.5em;\n  --padding-start: 1.5em;\n  --padding-top: 1.5em;\n}\n\n.upload_images {\n  color: #c4932f;\n  font-size: 12px;\n  margin: 5px 0px;\n}\n\n.list_2 {\n  text-align: center;\n  background: #f7f8fa;\n  border: 1px dashed #d4dce1;\n  border-radius: 10px;\n  padding: 2.5em 0em;\n}\n\n.list_9 {\n  text-align: center;\n  background: #f7f8fa;\n  border: 1px dashed #d4dce1;\n  border-radius: 10px;\n  padding: 3.7em 0em 2.5em 0em;\n  height: 163px;\n}\n\n.list_9 p {\n  color: #d2d6d8;\n  font-size: 12px;\n  margin: 0px;\n  margin-top: 8px;\n}\n\n.list_3 {\n  background: #f7f8fa;\n  border: 1px solid #d4dce1;\n  border-radius: 10px;\n  color: #000;\n  --placeholder-color: #b2b2b4;\n  font-size: 13px;\n  --padding-start: 1.5em;\n  --padding-top: 1.5em;\n}\n\n@media (orientation: portrait) {\n  .btn_footer {\n    margin: 0.7em 0em 1em 0em;\n    position: absolute;\n    width: 100%;\n    bottom: 10px;\n  }\n}\n\n@media (orientation: landscape) {\n  .btn_footer {\n    margin: 0.7em 0em 1em 0em;\n  }\n}\n\nion-slide span {\n  border: 1px solid #000;\n  border-radius: 22px;\n  padding: 8px 14px;\n  margin-left: 1em;\n}\n\n.num {\n  padding: 9px 10px !important;\n}\n\n.calender_slider {\n  background: #f7f8fa;\n  padding: 0.6em 0em;\n}\n\n.calender_slider_text {\n  margin: 0px;\n  position: relative;\n  top: -2px;\n  font-size: 18px;\n}\n\nion-slide {\n  margin-left: 0.6em;\n}\n\nion-slide:first-child {\n  margin-left: 0em;\n}\n\nion-button {\n  --padding-bottom: 1.5em;\n  --padding-top: 1.5em;\n  --box-shadow: none;\n}\n\n.btn_footer {\n  padding: 0.5em 1em 1.2em 1em;\n}\n\n.info {\n  background: #6e6d6d;\n  padding: 0.4em 0em;\n}\n\n.info p {\n  margin: 0px;\n  color: #fff;\n  font-size: 10px;\n}\n\nion-select {\n  background: #f7f8fa;\n  border: 1px solid #d4dce1;\n  border-radius: 30px;\n  --placeholder-color: #b2b2b4;\n  color: #000;\n  font-size: 13px;\n  --padding-start: 1.5em;\n  --padding-top: 1.5em;\n  --padding-bottom: 1.5em;\n  --padding-end: 1.5em;\n}\n\n.list_4 {\n  background: #f7f8fa;\n  border: 1px solid #d4dce1;\n  border-radius: 12px;\n  color: #d4dce1;\n  font-size: 13px;\n}\n\n.list_4 p {\n  margin: 0px;\n  color: #000;\n}\n\n.list_5 {\n  border-left: 1px dashed #c7c7c7;\n  height: 48px;\n  float: right;\n  margin-top: 12px;\n}\n\n.list_6 {\n  margin-bottom: 2em !important;\n}\n\n.list_7 {\n  height: 10px;\n  background: green;\n  width: 10px;\n  float: right;\n  position: relative;\n  right: 5px;\n  border-radius: 50%;\n  margin-top: 3px;\n}\n\n.list_8 {\n  height: 10px;\n  background: red;\n  width: 10px;\n  float: right;\n  position: relative;\n  right: 5px;\n  border-radius: 50%;\n}\n\n.activeState {\n  background: #c4932f;\n  border: 1px solid #c4932f !important;\n  color: #fff !important;\n}\n\n.activeEndState {\n  background: #c4932f;\n  border: 1px solid #c4932f !important;\n  color: #fff !important;\n}\n\n.footer-md::before {\n  left: 0;\n  top: -2px;\n  bottom: auto;\n  background-position: left 0 top 0;\n  position: absolute;\n  width: 100%;\n  height: 2px;\n  background-repeat: repeat-x;\n  content: \"\";\n}\n\n.footer-ios::before {\n  left: 0;\n  top: -2px;\n  bottom: auto;\n  background-position: left 0 top 0;\n  position: absolute;\n  width: 100%;\n  height: 2px;\n  background-repeat: repeat-x;\n  content: \"\";\n}\n\np {\n  display: block;\n  -webkit-margin-before: 0em;\n          margin-block-start: 0em;\n  -webkit-margin-after: 0em;\n          margin-block-end: 0em;\n  -webkit-margin-start: 0px;\n          margin-inline-start: 0px;\n  -webkit-margin-end: 0px;\n          margin-inline-end: 0px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    },
    ...
    /*! exports provided: Listcar7Page */

    /***/
    function srcAppListcar7Listcar7PageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "Listcar7Page", function () {
        return Listcar7Page;
      });
      /* harmony import */
      ...
      var Listcar7Page = /*#__PURE__*/function () {
        function Listcar7Page(loadingController, activatedRoute, popoverController, storage, toastController, router, restService, alertCtrl, imageService, menuCtrl, imageCompress, imagePicker, platform, location, navCtrl, transfer) {
          _classCallCheck(this, Listcar7Page);
                ...
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    ...
                    case 2:
                      ...
                      this.restService.listYourCarAPI(dataToInsert).subscribe(function (resAPI) {
                        loading.dismiss();
                        _this15.response = JSON.parse(resAPI['_body']);

                        if (_this15.response.status == 'success') {
                          _this15.storage.set("pickup", "");

                          _this15.storage.set("dropoff", "");

                          _this15.storage.set("pickuplong", "");

                          _this15.storage.set("pickuplat", "");

                          _this15.storage.set("dropofflong", "");

                          _this15.storage.set("dropofflat", "");

                          _this15.navCtrl.navigateForward('listcar8');
                        }
                      });
      ...
      Listcar7Page.ctorParameters = function () {
        return [{
      ...
      Listcar7Page = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-listcar7',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./listcar7.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/listcar7/listcar7.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./listcar7.page.scss */
        "./src/app/listcar7/listcar7.page.scss"))["default"]]
      })], Listcar7Page);
      /***/
    }
  }]);
})();
//# sourceMappingURL=listcar7-listcar7-module-es5.js.map