(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["reviews-or-rating-reviews-or-rating-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppReviewsOrRatingReviewsOrRatingPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppReviewsOrRatingReviewsOrRatingRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ReviewsOrRatingPageRoutingModule", function () {
        return ReviewsOrRatingPageRoutingModule;
      });
      /* harmony import */
      ...
      var _reviews_or_rating_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./reviews-or-rating.page */
      ...
      var ReviewsOrRatingPageRoutingModule = /*#__PURE__*/_createClass(function ReviewsOrRatingPageRoutingModule() {
        _classCallCheck(this, ReviewsOrRatingPageRoutingModule);
      });

      ReviewsOrRatingPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function srcAppReviewsOrRatingReviewsOrRatingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ReviewsOrRatingPageModule", function () {
        return ReviewsOrRatingPageModule;
      });
      /* harmony import */
      ...
      var _reviews_or_rating_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./reviews-or-rating-routing.module */
      "./src/app/reviews-or-rating/reviews-or-rating-routing.module.ts");
      /* harmony import */


      var _reviews_or_rating_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./reviews-or-rating.page */
      "./src/app/reviews-or-rating/reviews-or-rating.page.ts");

      var ReviewsOrRatingPageModule = /*#__PURE__*/_createClass(function ReviewsOrRatingPageModule() {
        _classCallCheck(this, ReviewsOrRatingPageModule);
      });

      ReviewsOrRatingPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _reviews_or_rating_routing_module__WEBPACK_IMPORTED_MODULE_5__["ReviewsOrRatingPageRoutingModule"]],
    ...
    /***/
    function srcAppReviewsOrRatingReviewsOrRatingPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppReviewsOrRatingReviewsOrRatingPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ReviewsOrRatingPage", function () {
        return ReviewsOrRatingPage;
      });
      /* harmony import */
      ...
      var ReviewsOrRatingPage = /*#__PURE__*/function () {
        function ReviewsOrRatingPage(restService, storage, router, menuCtrl, location, plateform) {
          _classCallCheck(this, ReviewsOrRatingPage);
          ...
          this.fillUpFour = 0;
          this.fillUpFive = 0;
          this.pet = 'byYou'; //console.log(Number((6.688689).toFixed(1)));
        }

        _createClass(ReviewsOrRatingPage, [{
          key: "ngOnInit",
          ...
          value: function giveRating() {
            ...
            var stringy = JSON.stringify({
              ...
              "veh_id": this.vehID // {"requestType": "get_veh_reviews", "veh_id": "1"}

            });
            console.log(stringy);
            this.restService.reviews(stringy).subscribe(function (response) {
              _this2.response = JSON.parse(response['_body']);
              console.log(_this2.response); //  this.others_reviews  = this.response.others_reviews;

              _this2.owns_reviews = _this2.response.veh_reviews; //  this.critical_ratings_others    = this.response.critical_ratings_others;

              _this2.storage.get('profile_img_url').then(function (profile_img_url) {});
            }, function (err) {});
          }
        }, {
          key: "favourite",
          value: function favourite(request, ratingsID, i) {
            var _this3 = this;
            ...
            if (this.userID) {
              ...
              console.log(stringy);
              this.restService.reviews(stringy).subscribe(function (response) {
                _this3.favResponse = JSON.parse(response['_body']);
                console.log(_this3.favResponse.status);

                if (_this3.favResponse.status == 'error') {} else if (_this3.favResponse.status == 'success') {
                  if (request == 'like_review') {
                    ...
                    _this3.others_reviews[i].is_liked = 1;
                    _this3.others_reviews = _this3.others_reviews;
                  } else if (request == 'unlike_review') {
                    var count = document.querySelector('.like_count_' + ratingsID).textContent;
                    var newCount = parseInt(count) - 1;
                    document.querySelector('.like_count_' + ratingsID).textContent = newCount.toString();
                    _this3.others_reviews[i].is_liked = 0;
                    _this3.others_reviews = _this3.others_reviews;
                  }
                }
              }, function (err) {});
          ...
          key: "View",
          value: function View(request, ratingsID, feedback) {
            var _this4 = this;
            ...
            if (this.userID) {
              ...
              console.log(stringy);
              this.restService.reviews(stringy).subscribe(function (response) {
                _this4.viewResponse = JSON.parse(response['_body']);
                console.log(_this4.viewResponse.status);

                if (_this4.viewResponse.status == 'error') {} else if (_this4.viewResponse.status == 'success') {
                  if (request == 'view_review') {
                    document.querySelector('.feedback_' + ratingsID).textContent = _this4.others_reviews[feedback].feedback;
          ...
          value: function Reviews(title) {
            if (title == 'Helpful') {
              ...
              this.others_reviews = this.response.critical_ratings_others; // alert(title);
            }
          }
        }, {
          key: "selectIndex",
      ...
      ReviewsOrRatingPage.ctorParameters = function () {
        return [{
      ...
      ReviewsOrRatingPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        selector: 'app-reviews-or-rating',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./reviews-or-rating.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/reviews-or-rating/reviews-or-rating.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./reviews-or-rating.page.scss */
        "./src/app/reviews-or-rating/reviews-or-rating.page.scss"))["default"]]
      })], ReviewsOrRatingPage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=reviews-or-rating-reviews-or-rating-module-es5.js.map