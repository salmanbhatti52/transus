        ...
        _createClass(ProfilePage, [{
          ...
          value: function ionViewWillEnter() {
            ...
            this.storage.get("user_details").then(function (user_details) {
              ...
              _this.userprofilefromuserdetail = user_details.profile_image;
            ...
            this.storage.get("profile_img_url").then(function (profile_img_url) {
              _this.storage.get("base_urls").then(function (base_url) {
                ...
                _this.profileImage = _this.restService.baseURLforProfileimg + "" + _this.userprofilefromuserdetail;
          ...
          value: function submitForm() {
            ...
            if (this.validateForm() == true) {
              ...
              this.restService.editProfile(stringy).subscribe(function (response) {
                ...
                console.log('profileupdated-----', _this3.response);
                ...
                if (_this3.response.status == "error") {
                  ...
                  _this3.subjectEvents.publishCityData(_this3.response.country); // console.log(this.usersService.profileVar, "testttttt");
          ...
          value: function getUserDetail() {
            ...
            this.restService.getUserDetails(stringy).subscribe(function (response) {
              ...
              if (_this4.response.status == "NotFound") {} else if (_this4.response.status == "Found") {
                localStorage.setItem('imageofuserprofile', _this4.restService.baseURLforProfileimg + "" + _this4.response.user_details.profile_image);
                _this4.restService.imageofuserprofile = _this4.restService.baseURLforProfileimg + "" + _this4.response.user_details.profile_image;
                _this4.usersService.profileVar = _this4.response.profile_img_url;

                _this4.subjectEvents.publishImgData(_this4.response.profile_img_url);
